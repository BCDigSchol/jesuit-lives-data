...
useful_cols = ['Id', 'dateOfDeath', 'Place of Death', 'lastName', 'latitude', 'longitude']
...
useful_columns = ['Id', 'dateOfDeath', 'Place of Death','lastName',]
...
with open(output_filename, 'w') as output_file:
    output_file.write('var deathplaces = {};'.format(geojson_str))
