...
for i in range (0, len(people)):
    ...
    people[i]['yearOfEntry'] = people[i]['Entrance_Date_1'][-4:]
...
def df_to_geojson(df, properties, provlon='provinceLongitude', provlat='provinceLatitude', birthlat='birthlatitude', birthlon='birthlongitude'):
    """
    ...
    for _, row in df.iterrows():
        ...
        feature['geometry']['coordinates'] = [[row[birthlon],row[birthlat]],[row[provlon],row[provlat]]]
...
output_filename = 'birthToProvinces.js'
with open(output_filename, 'w', encoding='utf8') as output_file:
    output_file.write('var birthToProvinces = {};'.format(geojson_str))
