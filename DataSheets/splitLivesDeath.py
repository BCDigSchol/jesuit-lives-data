...
def df_to_geojson(df, properties, provlon='provinceLongitude', provlat='provinceLatitude', deathlat='deathlatitude', deathlon='deathlongitude'):
    """
    ...
    for _, row in df.iterrows():
        ...
        feature['geometry']['coordinates'] = [[row[provlon],row[provlat]],[row[deathlon],row[deathlat]]]
...
output_filename = 'deathToProvinces.js'
with open(output_filename, 'w', encoding='utf8') as output_file:
    output_file.write('var deathToProvinces = {};'.format(geojson_str))
